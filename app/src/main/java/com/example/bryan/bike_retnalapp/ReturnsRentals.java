...
public class ReturnsRentals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_returns_rentals);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent takeUserToRentBike = new Intent(ReturnsRentals.this, HomePageActivity.class);
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(ReturnsRentals.this, "BACK BTN", Toast.LENGTH_LONG).show();
                Intent takeUserToRentBike = new Intent(ReturnsRentals.this, MainCampusActivity.class);
                startActivity(takeUserToRentBike);
            }
        });
        ...
        mContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (returnNumber.isEmpty()) {
                    ...
                    AlertDialog.Builder buidler = new AlertDialog.Builder(ReturnsRentals.this);
                    ...
                    ParseObject returningBikeMain = new ParseObject("Transaction");
